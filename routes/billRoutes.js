...
router.route("/insight/:start?/:end?").get(authController.protect, authController.restrictTo("admin"), billController.getinsight);
router.route("/unpaid").get(authController.protect, authController.restrictTo("admin"), billController.getunpaid);
router.route("/unupdatedDiscount").get(authController.protect, authController.restrictTo("admin"), billController.getunupdatedDiscount);

router.route("/validate").post(authController.protect, billController.validateData);
router.route("/updateDiscount").post(authController.protect, authController.restrictTo("admin"), billController.updateDiscount);
